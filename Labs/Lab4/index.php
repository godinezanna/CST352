...
if (isset($_GET['keyword'])) { //This checks whether the form has been submitted
    ...
    $layout = "horizontal";
    if (isset($_GET['layout'])){ //This checks wheather user has a layout (horizontal or vertical)
        $layout = $_GET['layout'];
    }
    
    if (!empty($_GET['category'])){ //This checks wheather user selected a category
